...
int main() {
    ...
    strcpy(cavaloP1, P "  PC2  ");
    strcpy(bispoP1, B "  PB3  ");
    strcpy(damaP, P "  PD4  ");
    strcpy(reiP, B "  PR5  ");
    strcpy(bispoP2, P "  PB6  ");
    strcpy(cavaloP2, B "  PC7  ");
    strcpy(torreP2, P "  PT8  ");
    strcpy(borda2, R "|8" );
    strcpy(borda3, R "7|" );
    strcpy(peaoP1, P "  PP1  ");
    strcpy(peaoP2, B "  PP2  ");
    ...
    strcpy(cavaloB1, B "  BC2  ");
    strcpy(bispoB1, P "  BB3  ");
    strcpy(damaB, B "  BD4  ");
    strcpy(reiB, P "  BR5  ");
    strcpy(bispoB2, B "  BB6  ");
    strcpy(cavaloB2, P "  BC7  ");
    strcpy(torreB2, B "  BT8  ");
    strcpy(borda16, R "|⇂" );
    strcpy(linha, R "  --------------------------------------------------------");
